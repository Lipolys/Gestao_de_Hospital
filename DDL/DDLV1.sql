...
CREATE TABLE atende(
  ...
  PRIMARY KEY (Codigo_convenio, Codigo_medico, Codigo_especialidade),
  FOREIGN KEY (Codigo_convenio) REFERENCES convenios (Codigo),
...
CREATE TABLE consulta(
  ...
  PRIMARY KEY (Codigo_paciente, Codigo_convenio, Codigo_medico, Codigo_especialidade, Data_hora),
  FOREIGN KEY (Codigo_paciente, Codigo_convenio) REFERENCES conveniado (Codigo_paciente, Codigo_convenio),
  FOREIGN KEY (Codigo_convenio, Codigo_medico, Codigo_especialidade) REFERENCES atende (Codigo_convenio, Codigo_medico, Codigo_especialidade));
...
CREATE TABLE internacoes(
  ...
  PRIMARY KEY (Codigo),
  FOREIGN KEY (Codigo_paciente, Codigo_convenio, Codigo_medico, Codigo_especialidade, Data_consulta)
  REFERENCES consulta (Codigo_paciente, Codigo_convenio, Codigo_medico, Codigo_especialidade, Data_hora),
  FOREIGN KEY (Codigo_quarto) REFERENCES quartos (Codigo));

-----------------------------------
-- DDL INDICE UNICO DE INTERNACAO
-----------------------------------
CREATE UNIQUE INDEX idx_consulta_internacao 
ON internacoes (Codigo_paciente, Codigo_convenio, Codigo_medico, Codigo_especialidade, Data_consulta);
...
CREATE TABLE receita_consulta(
  ...
  PRIMARY KEY (Codigo_paciente, Codigo_convenio, Codigo_medico, Codigo_especialidade, Data_consulta, Codigo_medicamento),
  FOREIGN KEY (Codigo_paciente, Codigo_convenio, Codigo_medico, Codigo_especialidade, Data_consulta)
  REFERENCES consulta (Codigo_paciente, Codigo_convenio, Codigo_medico, Codigo_especialidade, Data_hora),
